...
import { FaBox, FaSearch, FaTimes, FaPlus, FaShoppingCart } from "react-icons/fa";
    ...
    const fetchData = async () => {
      try {
        ...
        if (stockResponse.data.success) {
          const stocks = stockResponse.data.stocks || stockResponse.data.data || [];
        ...
        if (buyersResponse.data.success) {
          const buyers = buyersResponse.data.buyers || buyersResponse.data.data || [];
    ...
    <div className="spreturns-items-container">
      ...
      <div className="spreturns-items-content">
        ...
        <div className="spreturns-actions">
          <button className="spreturns-add-row-btn" onClick={addNewRow} disabled={loading}>
            <FaPlus />
            Add Row
          </button>
          <button
