...
function SPReturnInvoice() {
  ...
  return (
    <div className="spreturninvoice-container">
      ...
      <div id="spreturninvoice-content">
        <div className="spreturninvoice-header">
          <div className="spreturninvoice-header-top">
            ...
            <div className="spreturninvoice-number">
              ID: {buyerId}
            </div>
          </div>
        ...
        <div className="spreturninvoice-items-section">
          <div className="spreturninvoice-items-header">
            ...
            <div className="spreturninvoice-item-header-desc">Item Description</div>
          ...
          {invoiceData.map((item, index) => (
            <div key={index} className="spreturninvoice-item-row">
              ...
              <div className="spreturninvoice-item-description">{item.selectedItem}</div>
              <div className="spreturninvoice-item-price">${item.price.toFixed(2)}</div>
              <div className="spreturninvoice-item-qty">{item.quantity}</div>
              <div className="spreturninvoice-item-total">${item.total.toFixed(2)}</div>
            </div>
          ))}
        </div>
      ...
      {success && <div className="spreturninvoice-success-message">{success}</div>}
