...
import { FaBox, FaSearch, FaTimes, FaShoppingCart, FaMinus, FaPlus } from "react-icons/fa";
      ...
      <div className="indirectissue-items-content">
        ...
        <div className="indirectissue-search-container">
          <div className="indirectissue-search-input-wrapper">
            ...
            />
            {searchTerm && (
              <button className="indirectissue-clear-search" onClick={clearSearch}>
                <FaTimes />
              </button>
            )}
          </div>
        ...
        {!loading && !error && (
          <div className="indirectissue-table-container">
            <table className="indirectissue-items-table">
              ...
              <tbody>
                {rows.map((row, index) => (
                  <tr key={index} className="indirectissue-data-row">
                    ...
                    <td className={row.currentStock <= 5 ? "indirectissue-stock-warning" : "indirectissue-stock-value"}>
                      {row.currentStock}
                    </td>
                    ...
                    <td>
                      <div className="indirectissue-quantity-control">
                        ...
                        <button 
                          ...
                          disabled={!row.selectedItem || row.quantity >= row.currentStock}
                        >
                          <FaPlus />
                        </button>
                      </div>
              ...
              <tfoot>
                <tr>
                  <td colSpan="4" className="indirectissue-total-label">Grand Total:</td>
        ...
        <div className="indirectissue-button-container">
          ...
          <button
            className={`indirectissue-checkout-btn ${!buyerId ? 'indirectissue-disabled' : 'indirectissue-active'}`}
        ...
        {buyerId && rows.some(row => row.selectedItem) && (
          <div className="indirectissue-summary-panel">
            ...
            <div className="indirectissue-summary-content">
              <p><strong>Buyer:</strong> {indirectBuyers.find(b => b._id === buyerId)?.buyername || ''}</p>
              <p><strong>Items Selected:</strong> {rows.filter(r => r.selectedItem).length}</p>
