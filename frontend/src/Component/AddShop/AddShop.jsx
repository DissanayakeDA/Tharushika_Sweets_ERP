        ...
        return (
          <div className="addshop-form-step-content">
            ...
            <div className="addshop-form-group">
              ...
              {validationErrors.buyername && (
                <p className="addshop-error-message">{validationErrors.buyername}</p>
              )}
            </div>
            ...
            <div className="addshop-form-group">
              ...
              <div className="addshop-input-container">
                <FontAwesomeIcon icon={faStore} className="addshop-input-icon" />
                <input
                  type="text"
                  id="shopname"
                  name="shopname"
              ...
              {validationErrors.shopname && (
                <p className="addshop-error-message">{validationErrors.shopname}</p>
              )}
            </div>
          </div>
        );
        ...
        return (
          <div className="addshop-form-step-content">
            ...
            <div className="addshop-form-group">
              ...
              <div className="addshop-input-container">
                <FontAwesomeIcon icon={faPhone} className="addshop-input-icon" />
                <input
                  type="text"
                  id="contact"
                  name="contact"
              ...
              {validationErrors.contact && (
                <p className="addshop-error-message">{validationErrors.contact}</p>
              )}
            </div>
            ...
            <div className="addshop-form-group">
              ...
              <div className="addshop-input-container">
                <FontAwesomeIcon icon={faEnvelope} className="addshop-input-icon" />
                <input
                  type="text"
                  id="email"
                  name="email"
              ...
              {validationErrors.email && (
                <p className="addshop-error-message">{validationErrors.email}</p>
              )}
            </div>
            ...
            <div className="addshop-form-group">
              ...
              <div className="addshop-input-container">
                <FontAwesomeIcon icon={faMapMarkerAlt} className="addshop-input-icon addshop-textarea-icon" />
                <textarea
                  id="address"
                  name="address"
              ...
              {validationErrors.address && (
                <p className="addshop-error-message">{validationErrors.address}</p>
              )}
            </div>
          </div>
        );
  ...
  const renderSuccessMessage = () => (
    <div className="addshop-success-container">
      <div className="addshop-success-icon">
        <svg className="addshop-checkmark" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 52 52">
          <circle className="addshop-checkmark-circle" cx="26" cy="26" r="25" fill="none" />
          <path className="addshop-checkmark-check" fill="none" d="M14.1 27.2l7.1 7.2 16.7-16.8" />
        </svg>
      </div>
                    ...
                    {[...Array(totalSteps)].map((_, index) => (
                      ...
                      >
                        {currentStep > index + 1 ? (
                          ...
                          <span className="addshop-step-number">{index + 1}</span>
                        )}
                      </div>
                    ))}
                  </div>
