...
function SalesDashboard() {
  ...
  const calculateSummaryValues = (sales, returns, tf) => {
    ...
    const filteredReturns = returns.filter(ret => new Date(ret.date) >= startDate);
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        // Fetch stock data
        const stockResponse = await axios.get('http://localhost:5000/api/salesstocks');
        if (stockResponse.data) {
          ...
          } else if (stockResponse.data.stocks && Array.isArray(stockResponse.data.stocks)) {
        ...
        // Fetch sales data
        const salesResponse = await axios.get('http://localhost:5000/api/indirectsales');
        if (salesResponse.data.success) {
          const sales = salesResponse.data.sales;
          setSalesData(sales);

          // Fetch returns data
          const returnsResponse = await axios.get('http://localhost:5000/api/indirectreturns');
          ...
          const topSalesArray = Object.entries(productSales).map(([name, data]) => ({ name, ...data }));
          ...
          const totalPeriodSales = Object.values(dailyTotals).reduce((sum, val) => sum + val, 0);
      ...
      <div className="salesdash-main-content">
        <div className="salesdash-header">
          ...
          <div className="salesdash-timeframe-selector">
            <button 
              className={`salesdash-timeframe-btn ${timeframe === 'day' ? 'active' : ''}`}
              onClick={() => setTimeframe('day')}
            >
              <span>Today</span>
            </button>
            <button 
              className={`salesdash-timeframe-btn ${timeframe === 'week' ? 'active' : ''}`}
              onClick={() => setTimeframe('week')}
            >
              <span>This Week</span>
            </button>
            <button 
              className={`salesdash-timeframe-btn ${timeframe === 'month' ? 'active' : ''}`}
        ...
        <div className="salesdash-buttons">
          <Link to="/viewsalesstock" className="salesdash-link">
            <div className="salesdash-btn">
              ...
              <div className="salesdash-btn-content">
                ...
                <span className="salesdash-btn-description">Manage inventory levels</span>
              </div>
          ...
          <Link to="/requests" className="salesdash-link">
            <div className="salesdash-btn">
              <div className="salesdash-btn-icon">
              ...
              <div className="salesdash-btn-content">
                ...
                <span className="salesdash-btn-description">View and process requests</span>
              </div>
              <div className="salesdash-btn-arrow">
                <i className="bi bi-chevron-right"></i>
              </div>
          ...
          <Link to="/spsales" className="salesdash-link">
            <div className="salesdash-btn">
              ...
              <div className="salesdash-btn-content">
                ...
                <span className="salesdash-btn-description">Track sales progress</span>
              </div>
              <div className="salesdash-btn-arrow">
                <i className="bi bi-chevron-right"></i>
              </div>
              <div className="salesdash-count-badge-s">{summaryValues.totalOrders}</div>
            </div>
          </Link>

          <Link to="/manageitems" className="salesdash-link">
            <div className="salesdash-btn">
              <div className="salesdash-btn-icon">
              ...
              <div className="salesdash-btn-content">
                ...
                <span className="salesdash-btn-description">Manage product catalog</span>
              </div>
              <div className="salesdash-btn-arrow">
                <i className="bi bi-chevron-right"></i>
              </div>
          ...
          <Link to="/manageshops" className="salesdash-link">
            <div className="salesdash-btn">
              ...
              <div className="salesdash-btn-content">
                ...
                <span className="salesdash-btn-description">Manage retail locations</span>
              </div>
              <div className="salesdash-btn-arrow">
                <i className="bi bi-chevron-right"></i>
              </div>
          ...
          <Link to="/spviewreturns" className="salesdash-link">
            <div className="salesdash-btn">
              ...
              <div className="salesdash-btn-content">
                ...
                <span className="salesdash-btn-description">Process product returns</span>
              </div>
              <div className="salesdash-btn-arrow">
                <i className="bi bi-chevron-right"></i>
              </div>
              <div className="salesdash-count-badge-r">{summaryValues.totalReturns}</div>
            </div>
          </Link>
        </div>
        ...
        <div className="salesdash-grid">
          <div className="salesdash-chart-card compact">
            ...
            <p className="salesdash-chart-description">Current stock distribution by product category</p>
          ...
          <div className="salesdash-chart-card compact">
            ...
            <p className="salesdash-chart-description">Best performing products by sales volume</p>
            <div className="salesdash-chart-container">
              {loading ? (
                <div className="salesdash-loading-spinner">
                  <div className="salesdash-spinner"></div>
          ...
          <div className="salesdash-chart-card compact">
            ...
            <p className="salesdash-chart-description">Sales performance over the past week</p>
            <div className="salesdash-chart-container">
              {loading ? (
                <div className="salesdash-loading-spinner">
                  <div className="salesdash-spinner"></div>
