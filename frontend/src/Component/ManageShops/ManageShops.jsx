          ...
          <table className="manageshops-table">
            ...
            <tbody>
              {currentShops.length === 0 ? (
                <tr>
                  <td colSpan="6" className="manageshops-no-data">No shops found</td>
                </tr>
              ) : (
        ...
        {showEditModal && (
          <div className="manageshops-modal">
            <div className="manageshops-modal-content">
              ...
              <form onSubmit={handleEditSubmit} className="manageshops-edit-form">
                <div className="manageshops-form-group">
                  <label htmlFor="buyername">Buyer Name <span className="required">*</span></label>
                  <input
                    type="text"
                    id="buyername"
                    value={editingShop.buyername}
                    onChange={(e) => setEditingShop({...editingShop, buyername: e.target.value})}
                    className={validationErrors.buyername ? "error" : ""}
                  />
                  {validationErrors.buyername && (
                    <span className="error-message">{validationErrors.buyername}</span>
                  )}
                </div>
                <div className="manageshops-form-group">
                  ...
                  {validationErrors.shopname && (
                    <span className="error-message">{validationErrors.shopname}</span>
                  )}
                </div>
                <div className="manageshops-form-group">
                  ...
                  <input
                    ...
                    onChange={(e) => setEditingShop({...editingShop, contact: e.target.value})}
                ...
                <div className="manageshops-modal-buttons">
                  ...
                  <button 
                    type="submit" 
                    className="manageshops-save-btn"
                  >
                    Save Changes
                  </button>
                </div>
