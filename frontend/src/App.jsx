    ...
    <div>
      <React.Fragment>
        <Routes>
          ...
          <Route
            path="/viewbuyers/:id"
            element={<ProtectedRoute element={<UpdateBuyers />} />}
          />
          <Route
            path="/invoice"
          ...
          <Route
            path="/addsuppliers"
            element={<ProtectedRoute element={<AddSuppliers />} />}
          />
          <Route
            path="/home-gm"
          ...
          <Route
            path="/GMviewrequests"
            element={<ProtectedRoute element={<GMrequests />} />}
          />
          <Route
            path="/GMviewemployee"
          ...
          />
          <Route
            path="/GMviewsuppliers"
            element={<ProtectedRoute element={<GMsupplier />} />}
          />
          <Route
            path="/GMviewproducts"
